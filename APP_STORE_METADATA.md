...
• Share lists with other Tokilist users
...
| Profanity or Crude Humor | Infrequent/Mild (UGC) |
...
**Expected Rating: 4+ or 9+** (due to user-generated content)
...
- [x] Light mode icon
- [x] Dark mode icon (iOS 18+)
- [ ] Tinted icon variant (iOS 18+ — optional)
...
| User ID | Yes | Yes | No |
| Photos (profile pic) | Yes | Yes | No |
| Push Token | Yes | Yes | No |
| Usage Data | No | No | No |
| Diagnostics | No | No | No |

**Data used for:** App Functionality
**Data linked to user:** Name, Email, User ID, Profile Photo, Push Token
**Data NOT used for tracking:** All categories
