...
export const LeagueSettingsSheet = forwardRef<
  ...
  LeagueSettings
>(({ leagueId, name, description, songsPerRound, upvotePointsPerRound, allowDownvotes }, ref) => {
  ...
  const [editUpvotePoints, setEditUpvotePoints] = useState(upvotePointsPerRound);
  const [editAllowDownvotes, setEditAllowDownvotes] = useState(allowDownvotes);
  ...
  }, [name, description, songsPerRound, upvotePointsPerRound, allowDownvotes]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Settings */}
        <Text className="mb-3 text-lg font-bold text-[#DCE4E4]">Settings</Text>
