...
export function SignInButtons({ returnUrl }: { returnUrl?: string } = {}) {
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
        <form>
          <button
            type="submit"
            formAction={signInWithApple.bind(null, returnUrl)}
        ...
        <form>
          <button
            type="submit"
            formAction={signInWithGoogle.bind(null, returnUrl)}
            className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/5 px-6 py-3 transition-colors hover:bg-white/10 sm:w-auto"
          >
        ...
        <form>
          <button
            type="submit"
            formAction={signInWithDiscord.bind(null, returnUrl)}
            className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/5 px-6 py-3 transition-colors hover:bg-white/10 sm:w-auto"
          >
            <svg
