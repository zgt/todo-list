...
export const tw = {
  ...
  pillActive:
    "bg-[#50C87833] border-2 border-[#21716C] text-[#50C878] rounded-full px-6 py-2",
  pillInactive:
    "bg-transparent border-2 border-[#164B49] text-[#8FA8A8] rounded-full px-6 py-2",

  buttonPrimary:
    "bg-[#50C878] text-[#0A1A1A] hover:bg-[#66D99A] active:bg-[#388E3C] rounded-md px-4 py-3 font-semibold transition-colors duration-200",
  buttonGhost:
    "bg-transparent text-[#DCE4E4] hover:bg-[#183F3F] rounded-md px-4 py-3 transition-colors duration-200",
  buttonDestructive: "text-[#E57373] font-bold uppercase text-sm",

  input:
    "bg-[#102A2A] border border-[#164B49] focus:border-[#21716C] text-[#DCE4E4] placeholder:text-[#8FA8A8] rounded-md px-3 py-2",
