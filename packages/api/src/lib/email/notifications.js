...
function getLeagueMembers(leagueId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client_1.db.query.LeagueMember.findMany({
...
function notifyRoundStarted(roundId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, client_1.db.query.Round.findFirst({
                ...
                case 3:
                    ...
                    if ((prefs === null || prefs === void 0 ? void 0 : prefs.roundStart) === false)
                        return [3 /*break*/, 5];
                    ...
                    }), subject = _a.subject, html = _a.html;
                    return [4 /*yield*/, (0, client_2.sendEmail)({ to: member.user.email, subject: subject, html: html })];
                case 4:
                    _b.sent();
                    _b.label = 5;
                case 5:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    member = members_2[_i];
                    prefs = member.user.notificationPreferences;
                    if ((prefs === null || prefs === void 0 ? void 0 : prefs.votingOpen) === false)
                        return [3 /*break*/, 5];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    member = members_3[_i];
                    prefs = member.user.notificationPreferences;
                    if ((prefs === null || prefs === void 0 ? void 0 : prefs.resultsAvailable) === false)
                        return [3 /*break*/, 5];
...
function sendSubmissionReminders(roundId) {
    return __awaiter(this, void 0, void 0, function () {
        var round, members, submissions, submittedUserIds, _i, members_4, member, prefs, _a, subject, html;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, client_1.db.query.Round.findFirst({
                        where: (0, db_1.eq)(schema_1.Round.id, roundId),
                ...
                case 2:
                    members = _b.sent();
                    return [4 /*yield*/, client_1.db.query.Submission.findMany({
                            where: (0, db_1.eq)(schema_1.Submission.roundId, roundId),
                        })];
                case 3:
                    submissions = _b.sent();
                    submittedUserIds = new Set(submissions.map(function (s) { return s.userId; }));
                ...
                case 4:
                    ...
                    if (submittedUserIds.has(member.userId))
                        return [3 /*break*/, 6];
                    prefs = member.user.notificationPreferences;
                    if ((prefs === null || prefs === void 0 ? void 0 : prefs.submissionReminder) === false)
                        return [3 /*break*/, 6];
