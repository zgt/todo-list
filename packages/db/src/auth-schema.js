...
exports.accountRelations =
  exports.sessionRelations =
...
exports.user = (0, pg_core_1.pgTable)("user", {
  ...
  updatedAt: (0, pg_core_1.timestamp)("updated_at")
    .defaultNow()
    .$onUpdate(function () {
      /* @__PURE__ */ return new Date();
    })
    .notNull(),
});
exports.session = (0, pg_core_1.pgTable)(
  "session",
  {
    id: (0, pg_core_1.text)("id").primaryKey(),
  ...
  function (table) {
    return [(0, pg_core_1.index)("session_userId_idx").on(table.userId)];
  },
);
exports.account = (0, pg_core_1.pgTable)(
  "account",
  {
    id: (0, pg_core_1.text)("id").primaryKey(),
  ...
  function (table) {
    return [(0, pg_core_1.index)("account_userId_idx").on(table.userId)];
  },
);
exports.verification = (0, pg_core_1.pgTable)(
  "verification",
  {
    id: (0, pg_core_1.text)("id").primaryKey(),
  ...
  function (table) {
    return [
      (0, pg_core_1.index)("verification_identifier_idx").on(table.identifier),
    ];
  },
);
...
exports.sessionRelations = (0, drizzle_orm_1.relations)(
  exports.session,
  function (_a) {
    var one = _a.one;
    return {
...
exports.accountRelations = (0, drizzle_orm_1.relations)(
  exports.account,
  function (_a) {
    var one = _a.one;
    return {
