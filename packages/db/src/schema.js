...
exports.userRelations = exports.commentRelations = exports.voteRelations = exports.submissionRelations = exports.roundRelations = exports.leagueMemberRelations = exports.leagueRelations = exports.taskListInviteRelations = exports.taskListMemberRelations = exports.taskListRelations = exports.subtaskRelations = exports.taskRelations = exports.categoryRelations = exports.UpdateTaskListSchema = exports.CreateTaskListSchema = exports.UpdateCategorySchema = exports.CreateCategorySchema = exports.UpdateSubtaskSchema = exports.CreateSubtaskSchema = exports.UpdateTaskSchema = exports.CreateTaskSchema = exports.ThemeTemplate = exports.userPreferenceRelations = exports.UserPreference = exports.pushTokenRelations = exports.PushToken = exports.Comment = exports.Vote = exports.Submission = exports.Round = exports.LeagueMember = exports.League = exports.TaskListInvite = exports.TaskListMember = exports.Subtask = exports.Task = exports.TaskList = exports.Category = exports.CreatePostSchema = exports.Post = exports.roundStatusEnum = exports.memberRoleEnum = exports.leagueStatusEnum = exports.TaskPriority = void 0;
...
exports.Category = (0, pg_core_1.pgTable)("category", function (t) { return ({
    id: t.uuid().notNull().primaryKey().defaultRandom(),
    userId: t
        .text("user_id")
        .notNull()
    ...
    path: t
        ...
        .array()
        .notNull()
        .default((0, drizzle_orm_1.sql)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["ARRAY[]::uuid[]"], ["ARRAY[]::uuid[]"])))),
    ...
    (0, pg_core_1.index)("category_user_id_sort_order_idx").on(table.userId, table.sortOrder),
    (0, pg_core_1.index)("category_parent_id_idx").on(table.parentId),
    (0, pg_core_1.index)("category_user_id_path_idx").on(table.userId, table.path),
    (0, pg_core_1.index)("category_user_id_depth_idx").on(table.userId, table.depth),
    (0, pg_core_1.check)("category_no_self_reference", (0, drizzle_orm_1.sql)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", " IS NULL OR ", " != ", ""], ["", " IS NULL OR ", " != ", ""])), table.parentId, table.parentId, table.id)),
]; });
exports.TaskList = (0, pg_core_1.pgTable)("task_list", function (t) { return ({
    id: t.uuid().notNull().primaryKey().defaultRandom(),
    ...
    updatedAt: t
        ...
        .$onUpdate(function () { return new Date(); }),
    deletedAt: t.timestamp("deleted_at", { withTimezone: true, mode: "date" }),
}); }, function (table) { return [(0, pg_core_1.index)("task_list_owner_id_idx").on(table.ownerId)]; });
exports.Task = (0, pg_core_1.pgTable)("task", function (t) { return ({
    id: t.uuid().notNull().primaryKey().defaultRandom(),
    userId: t
        .text("user_id")
        .notNull()
    ...
    categoryId: t
        .uuid("category_id")
        .references(function () { return exports.Category.id; }, { onDelete: "set null" }),
    listId: t
        .uuid("list_id")
        .references(function () { return exports.TaskList.id; }, { onDelete: "set null" }),
    ...
    (0, pg_core_1.index)("task_user_id_deleted_at_order_idx").on(table.userId, table.deletedAt, table.orderIndex),
    (0, pg_core_1.index)("task_user_id_completed_created_idx").on(table.userId, table.completed, table.createdAt),
    (0, pg_core_1.index)("task_user_id_archived_at_idx").on(table.userId, table.archivedAt),
    (0, pg_core_1.index)("task_category_id_idx").on(table.categoryId),
    (0, pg_core_1.index)("task_list_id_idx").on(table.listId),
    (0, pg_core_1.index)("task_user_id_priority_completed_idx").on(table.userId, table.priority, table.completed),
    (0, pg_core_1.index)("task_reminder_at_idx").on(table.reminderAt),
    (0, pg_core_1.check)("task_priority_valid", (0, drizzle_orm_1.sql)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["", " IS NULL OR ", " IN ('high', 'medium', 'low')"], ["", " IS NULL OR ", " IN ('high', 'medium', 'low')"])), table.priority, table.priority)),
]; });
exports.Subtask = (0, pg_core_1.pgTable)("subtask", function (t) { return ({
    id: t.uuid().notNull().primaryKey().defaultRandom(),
    taskId: t
        .uuid("task_id")
        .notNull()
        .references(function () { return exports.Task.id; }, { onDelete: "cascade" }),
    title: t.varchar({ length: 500 }).notNull(),
    completed: t.boolean().notNull().default(false),
    sortOrder: t.integer("sort_order").notNull().default(0),
    createdAt: t
    ...
    (0, pg_core_1.index)("subtask_task_id_sort_order_idx").on(table.taskId, table.sortOrder),
]; });
exports.TaskListMember = (0, pg_core_1.pgTable)("task_list_member", function (t) { return ({
    id: t.uuid().notNull().primaryKey().defaultRandom(),
    listId: t
        .uuid("list_id")
        .notNull()
        .references(function () { return exports.TaskList.id; }, { onDelete: "cascade" }),
    userId: t
        .text("user_id")
        .notNull()
        .references(function () { return auth_schema_1.user.id; }, { onDelete: "cascade" }),
    role: t.varchar({ length: 20 }).notNull().default("editor"),
    invitedBy: t.text("invited_by").references(function () { return auth_schema_1.user.id; }),
    joinedAt: t
    ...
    (0, pg_core_1.uniqueIndex)("task_list_member_list_user_unique").on(table.listId, table.userId),
    (0, pg_core_1.index)("task_list_member_user_id_idx").on(table.userId),
]; });
exports.TaskListInvite = (0, pg_core_1.pgTable)("task_list_invite", function (t) { return ({
    id: t.uuid().notNull().primaryKey().defaultRandom(),
    listId: t
        .uuid("list_id")
        .notNull()
    ...
    createdBy: t
        .text("created_by")
        .notNull()
        .references(function () { return auth_schema_1.user.id; }),
    createdAt: t
        .timestamp("created_at", { withTimezone: true, mode: "date" })
        .$defaultFn(function () { return new Date(); })
        .notNull(),
...
// Music League Tables
exports.League = (0, pg_core_1.pgTable)("league", function (t) { return ({
    id: t
        .text()
        .notNull()
        .primaryKey()
    ...
    updatedAt: t
        ...
        .$onUpdate(function () { return new Date(); })
        .notNull(),
    status: (0, exports.leagueStatusEnum)("status").default("ACTIVE").notNull(),
...
exports.LeagueMember = (0, pg_core_1.pgTable)("league_member", function (t) { return ({
    id: t
        .text()
        .notNull()
        .primaryKey()
    ...
    leagueId: t
        .text("league_id")
        .notNull()
        .references(function () { return exports.League.id; }, { onDelete: "cascade" }),
    userId: t
        .text("user_id")
        .notNull()
        .references(function () { return auth_schema_1.user.id; }, { onDelete: "cascade" }),
    ...
    (0, pg_core_1.index)("league_member_league_user_unique").on(table.leagueId, table.userId),
]; });
exports.Round = (0, pg_core_1.pgTable)("round", function (t) { return ({
    id: t
        .text()
        .notNull()
        .primaryKey()
    ...
    status: (0, exports.roundStatusEnum)("status").default("SUBMISSION").notNull(),
    startDate: t
        .timestamp("start_date", { withTimezone: true, mode: "date" })
        .notNull()
        .default((0, drizzle_orm_1.sql)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["now()"], ["now()"])))),
    ...
    leagueId: t
        ...
        .notNull()
        .references(function () { return exports.League.id; }, { onDelete: "cascade" }),
}); }, function (table) { return [(0, pg_core_1.index)("round_league_id_idx").on(table.leagueId)]; });
exports.Submission = (0, pg_core_1.pgTable)("submission", function (t) { return ({
    id: t
        .text()
        .notNull()
        .primaryKey()
    ...
    roundId: t
        .text("round_id")
        .notNull()
        .references(function () { return exports.Round.id; }, { onDelete: "cascade" }),
    userId: t
        .text("user_id")
        .notNull()
        .references(function () { return auth_schema_1.user.id; }, { onDelete: "cascade" }),
    ...
    (0, pg_core_1.index)("submission_round_user_track_unique").on(table.roundId, table.userId, table.spotifyTrackId),
]; });
exports.Vote = (0, pg_core_1.pgTable)("vote", function (t) { return ({
    id: t
        .text()
        .notNull()
        .primaryKey()
    ...
    submissionId: t
        .text("submission_id")
        .notNull()
        .references(function () { return exports.Submission.id; }, { onDelete: "cascade" }),
}); }, function (table) { return [
    (0, pg_core_1.index)("vote_submission_id_idx").on(table.submissionId),
    (0, pg_core_1.index)("vote_voter_id_idx").on(table.voterId),
    (0, pg_core_1.index)("vote_round_voter_submission_unique").on(table.roundId, table.voterId, table.submissionId),
]; });
exports.Comment = (0, pg_core_1.pgTable)("comment", function (t) { return ({
    id: t
        .text()
        .notNull()
        .primaryKey()
    ...
    (0, pg_core_1.index)("comment_submission_user_unique").on(table.submissionId, table.userId),
]; });
// Push Notification Tokens
exports.PushToken = (0, pg_core_1.pgTable)("push_token", function (t) { return ({
    id: t
        .text()
        .notNull()
        .primaryKey()
...
exports.pushTokenRelations = (0, drizzle_orm_1.relations)(exports.PushToken, function (_a) {
    var one = _a.one;
    return ({
...
exports.UserPreference = (0, pg_core_1.pgTable)("user_preference", function (t) { return ({
    id: t.uuid().notNull().primaryKey().defaultRandom(),
    userId: t
        .text("user_id")
        .notNull()
...
exports.userPreferenceRelations = (0, drizzle_orm_1.relations)(exports.UserPreference, function (_a) {
    var one = _a.one;
    return ({
        user: one(auth_schema_1.user, {
...
exports.ThemeTemplate = (0, pg_core_1.pgTable)("theme_template", function (t) { return ({
    id: t
        .text()
        .notNull()
        .primaryKey()
...
exports.CreateSubtaskSchema = (0, drizzle_zod_1.createInsertSchema)(exports.Subtask, {
    title: v4_1.z.string().min(1, "Title is required").max(500),
...
exports.CreateCategorySchema = (0, drizzle_zod_1.createInsertSchema)(exports.Category, {
    name: v4_1.z.string().min(1, "Name is required").max(100),
    color: v4_1.z.string().regex(/^#[0-9A-Fa-f]{6}$/, "Must be a valid hex color"),
...
exports.CreateTaskListSchema = (0, drizzle_zod_1.createInsertSchema)(exports.TaskList, {
...
exports.taskRelations = (0, drizzle_orm_1.relations)(exports.Task, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
...
exports.subtaskRelations = (0, drizzle_orm_1.relations)(exports.Subtask, function (_a) {
    var one = _a.one;
    return ({
...
exports.taskListRelations = (0, drizzle_orm_1.relations)(exports.TaskList, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
...
exports.taskListMemberRelations = (0, drizzle_orm_1.relations)(exports.TaskListMember, function (_a) {
    var one = _a.one;
    return ({
        list: one(exports.TaskList, {
...
exports.taskListInviteRelations = (0, drizzle_orm_1.relations)(exports.TaskListInvite, function (_a) {
    var one = _a.one;
    return ({
        list: one(exports.TaskList, {
...
exports.leagueRelations = (0, drizzle_orm_1.relations)(exports.League, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
...
exports.leagueMemberRelations = (0, drizzle_orm_1.relations)(exports.LeagueMember, function (_a) {
    var one = _a.one;
    return ({
...
exports.roundRelations = (0, drizzle_orm_1.relations)(exports.Round, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        league: one(exports.League, {
...
exports.submissionRelations = (0, drizzle_orm_1.relations)(exports.Submission, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
...
exports.voteRelations = (0, drizzle_orm_1.relations)(exports.Vote, function (_a) {
    var one = _a.one;
    return ({
        round: one(exports.Round, {
...
exports.commentRelations = (0, drizzle_orm_1.relations)(exports.Comment, function (_a) {
    var one = _a.one;
    return ({
        submission: one(exports.Submission, {
...
exports.userRelations = (0, drizzle_orm_1.relations)(auth_schema_1.user, function (_a) {
    var many = _a.many;
    return ({
